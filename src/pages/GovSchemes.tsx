...
const GovSchemes = () => {
  ...
  const filteredSchemes = govSchemes.filter((scheme) =>
    String(t(`scheme_${scheme.id}_name` as any))
      .toLowerCase()
        ...
        <ScrollReveal>
          <div className="text-center mb-10">
            ...
            <div className="max-w-md mx-auto mt-4">
              <input
                type="text"
                placeholder={String(t("searchSchemesPlaceholder" as any))}
                value={search}
                ...
                <div className="space-y-3 text-sm flex-1">
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      {t(`scheme_${scheme.id}_eligibility` as any)}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-muted-foreground list-disc list-inside text-sm">
                      <li>{t(`scheme_${scheme.id}_doc1` as any)}</li>
                      <li>{t(`scheme_${scheme.id}_doc2` as any)}</li>
                      <li>{t(`scheme_${scheme.id}_doc3` as any)}</li>
                    </ul>
                  </div>
                </div>
